...
run_member(; case_name = getarg(args, "case", "1.D"),
             ...
             shear_amplitude = getarg(args, "shear", 1.0),
             noise_amplitude = getarg(args, "noise", 0.0),
             stokes_factor = getarg(args, "stokes_factor", 1.0),
             wind_stress = getarg(args, "wind_stress", 0.0),
             snapshot_offsets = haskey(args, "snapshot_offsets") ? Tuple(parse.(Float64, split(args["snapshot_offsets"], ','))) : (-3, -1, 0, 1, 3, 4),
