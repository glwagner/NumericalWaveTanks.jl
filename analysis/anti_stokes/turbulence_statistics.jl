...
output = get(args, "output", joinpath(figure_directory(), "turbulence_statistics_$(case_dirname(c))_$(ct.meta["level"])$(is_bounded_x(ct) ? "_boundedx" : "")_seed$(ct.meta["seed"]).png"))
save(output, fig)
@info "Saved $output"
